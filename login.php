                    ...
                    <div class="card overflow-hidden">
                        <div class="bg-primary">
                            <div class="text-primary text-center p-4">
                                <h5 class="text-white font-size-20">Welcome Back User!</h5>
                        ...
                        if (isset($_POST['signin'])){
                            ...
                            $username = mysqli_escape_string($conn,$_POST['Admin']);
                        ...
                        }elseif ($maineg->Admin_login('admin','username','password',$username,$password)){
                            ...
                            <div class="p-3">
                                <form  method="POST" class="mt-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="Admin" class="form-control" id="username" placeholder="Enter username">
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                       ...
                                       <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-12 text-end">
                                            <button class="btn btn-primary w-md waves-effect waves-light form-control" type="submit" name="signin">Log In</button>
                                        </div>
                                    </div>
