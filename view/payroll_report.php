    <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h6 class="page-title">Payroll Report</h6>
                                </div>
        ...
        <div  class="mb-3 col-lg-4">
         <input type="submit" class="btn btn-primary btn-block form-control" value="Search" id="ValNO" onclick="mesansOFidentifacartion_change();getMeSalesTotal();" >
        </div>
 ...
 <table class="mt-4 float-left" >
         ...
         <table class="mt-4 float-right" id="tabSum">
            <tr>
                <td class="bg-light">Total Staff Payroll Amount: &nbsp;</td>
                <td><b class="form-control btn btn-danger" id="sum_total_payroll">0</b></td>
...
function mesansOFidentifacartion_change() {
    ...
    var url = "Control/ajaxController.php?payrollReport="+tr;
...
function getMeSalesTotal() {
    ...
    var todate = document.getElementById("todate").value;
    var tr = fromdate+"_"+todate;
    var url = "Control/ajaxController.php?gettotalPayroll="+tr;


    xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                 document.getElementById("sum_total_payroll").innerHTML = number_format(this.responseText);
             // $("#tblBody").html(this.responseText);
        // document.getElementById('basic_salary').innerHTML = this.responseText;
            }
        };
