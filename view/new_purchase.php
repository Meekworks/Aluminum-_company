                                    ...
                                    <div class="card-body">
                                       <!--  <h4 class="card-title">Add New Product</h4>
                                        ...
                                        <form method="post">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <input type="text" hidden name="product_code" id="product_code" >
                                                    </div>
                                                ...
                                                <div class="col-sm-3">
                                                 ...
                                                 <div id="qty1" hidden class="col-sm-3">
                                                  <label id="qty2" class="col-form-label">Quantity</label>
                                               
                                                    <input hidden id="qty3" type="number" name="quantity" class="form-control"
                                                    >
                                                     <input type="text" hidden name="user" value="<?php echo $Admin['username']; ?>">
                                                </div>

                                                 <div id="packet1" hidden class="col-sm-3">
                                                    <label id="packet2" hidden class="col-form-label">Packets</label>
                                                    <input id="packet3" hidden  type="text" name="packet" class="form-control"
                                                    >
                                                </div> 
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div hidden id="label1" class="col-sm-3">
                                                <label hidden id="label2" class="col-form-label">Container Label</label>
                                                   <select  class="form-control" hidden name="container" id="label" onchange="fetchseriesname()">
                                                            <option disabled selected>--Select Container Label--</option>
                                                    </select>
                                                </div>


                                                <div hidden id="s_name1" class="col-sm-3">
                                                 <label hidden id="s_name2" class="col-form-label">Serial Name</label>
                                                    <select hidden class="form-control" name="serial_name" id="s_name">
                                                        <option>none</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row mb-3">
                                                <div id="kg_weight1" hidden class="col-sm-3">
                                                    <label id="kg_weight2" hidden class="col-form-label">KG(Weight)</label>
                                                    <input id="kg_weight3" hidden   type="text" name="kg_weight" class="form-control"
                                                   >
                                                </div>

                                                <div id="meter_length1" hidden class="col-sm-3">
                                                    <label id="meter_length2" hidden class="col-form-label">Meter (Length)</label>
                                                    <input id="meter_length3" hidden  type="text" name="meter_length" class="form-control"
                                                    >
                                                </div>

                                                 <div id="embossed1" hidden class="col-sm-3">
                                                    <label id="embossed2" hidden class="col-form-label">Embossed</label>
                                                     <select id="embossed3" hidden  class="form-control" name="embossed">
                                                        <option>None</option>
                                                 ...
                                                 <div id="design1" hidden class="col-sm-3">
                                                    <label id="design2" hidden class="col-form-label">Design</label>
                                                    <select id="design3" hidden  class="form-control" name="design" >
                                                        <option>None</option>
                                                        <option>None</option>
                                          ...
                                          <div class="form-group row mb-3">
                                             ...
                                             <div id="guage1" hidden class="col-sm-4">
                                                <label id="guage2" hidden class="col-form-label">Guage</label>
                                                <input  type="text" hidden name="stock_level" value="1" class="form-control">
                                                 <select hidden id="guage3" class="form-control" name="guage" >
                                                    <option>None</option>
                                                    <option>0.15</option>
                                                    <option>0.16</option>
                                                    <option>0.17</option>
                                            ...
                                            <div hidden id="color1" class="col-sm-4">
                                                <label hidden id="color2" class="col-form-label">Color</label>
                                                 <select hidden id="color3" class="form-control" name="color" >
                                                    <option>None</option>
                                                    <option>Black</option>
                                                    <option>Red</option>
                                                    <option>Green</option>
                                        ...
                                        <div class="col-sm-4">
                                         <label class="col-form-label">Supplier Name</label>
                                           <select class="form-control" name="supplier" id="supplier" onchange="fetchSupplier();">
                                            ...
                                            <input type="text" hidden name="supplier_id"  id="supplier_id">    
                                        </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            <div class="col-sm-6">
                                               <br>
                                               <input type="hidden" name="inputter" value="<?php if(isset($_SESSION['Admin'])) {echo $Admin['username'];}?>">
