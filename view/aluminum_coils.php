...
?>
    ...
    <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h6 class="page-title">New Sales Aluminium Coils </h6>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="col-12">
                               <div class="card">
                                    ...
                                    $result = $maineg->GetStockinnew('Aluminium Coils');
                                    $count = 1; 
                                    ...
                                    <tr>
                                     ...
                                     <td><a class="btn btn-primary btn-sm btn-responsive text-white" href="?action=SaleListAlumCoils&&saleDeatails='.$result[$k]["item_code"].'">Add_List</a></td>
                                    </tr>
                                    '; }}?>
