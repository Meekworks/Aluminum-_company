                    <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h6 class="page-title">Return View</h6>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        $result = $maineg->allReturnOutward("damaged");
                                        $count = 1; 
                                    if (!empty($result)) {
                                    ...
                                    echo '
                                     ...
                                     <td>'.$result[$k]["return_date"].'</td>';
                                      ...
                                      if($result[$k]["approval"] == "Unapproved"){
                                         echo '<td><a href="?action=ApproveR&&viewUnapprove='.$result[$k]["reference_no"].'"><span class="btn btn-danger btn-block btn-sm btn-responsive text-white text-center">Approve</span></a></td>';
                                     ...
                                     if($result[$k]["approval"] == "Unapproved"){
                                         echo '<td><span class="text-danger text-center">Not Approved</span></td> ';
                                     }elseif($result[$k]["status"] == "unsettled"){

                                         echo '<td><a href="?action=SettleR&&viewUnsettle='.$result[$k]["reference_no"].'"><span class="btn btn-primary btn-block btn-sm btn-responsive text-white text-center">Settle</span></a></td>';
